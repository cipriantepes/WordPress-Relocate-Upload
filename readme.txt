=== Relocate Upload ===
Contributors: alanft,tberneman,cipriantepes
...
== Changelog ==
0.24.1 - Tested with WordPress 4.6
         Tested on multisite
         URL to file displays correctly now
         Fixed hardcoded form action
         Files can be moved from folder to folder
